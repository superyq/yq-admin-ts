...
import Search from "@/pages/dict/components/Search.vue";
import Table from "@/pages/dict/components/Table.vue";
import Form from "@/pages/dict/components/Form.vue";
...
const handleShow = (row: any = null) => {
  const isEdit = !!row;
  formId.value = isEdit ? row.dictId : "";
  title.value = `${isEdit ? "编辑" : "新增"}字典`;
  show.value = true;
};
const handleSubmit = () => {
